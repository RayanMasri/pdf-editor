...
class CanvasImage:
    ...
    def __init__(self, canvas, placeholder, path):
...
class MainWindow(ttk.Frame):
    """ Main window class """
    def __init__(self, canvas, mainframe, path):
        ...
        canvas = CanvasImage(canvas, self.master, path)  # create widget
        canvas.grid(row=0, column=0)  # show widget

filename = './1.jpeg'  # place path to your image here
root = tk.Tk()
canvas = tk.Canvas(root)

app = MainWindow(canvas, root, path=filename)
root.mainloop()